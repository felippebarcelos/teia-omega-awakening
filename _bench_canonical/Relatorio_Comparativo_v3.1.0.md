...
| Motor v0.6.1 tamanho | 23477 bytes |
| Harness | v3.2.0 |
| pwsh startup | 269 ms |
...
Legenda: † = decode_ms inclui startup pwsh (~269ms); net_ratio = (seed+motor)/orig
...
|-----------|--------|--------|--------|-----------|--------|--------|--------|--------|
| `brotli` | 13 | 0 | 0,0025 | 0,00 | 6 | 68 | n/a | ✅ |
| `teia_v0.5` † | 189 | 0 | 0,0360 | 1,63 | 15 | 244 | 14.8 | ✅ |
| `teia_v0.6` † | 189 | 0 | 0,0360 | 2,99 | 15 | 201 | 21.8 | ✅ |
| `teia_v0.6.1_raw` † | 189 | 0 | 0,0360 | 4,51 | 15 | 203 | 22.4 | ✅ |
| `lzma` | 281 | 0 | 0,0536 | 0,05 | 72 | 134 | n/a | ✅ |
| `deflate` | 526 | 0 | 0,1003 | 0,10 | 4 | 77 | n/a | ✅ |
| `gzip` | 544 | 0 | 0,1038 | 0,10 | 12 | 80 | n/a | ✅ |
...
| Compressor | Repr(B) | Dict(B) | Ratio% | Net Ratio% | Enc(ms) | Dec(ms) | RAM(MB) | SHA-256 |
|-----------|--------|--------|--------|-----------|--------|--------|--------|--------|
| `brotli` | 23 | 0 | 0,0088 | 0,01 | 1 | 47 | n/a | ✅ |
| `teia_v0.5` † | 220 | 16 | 0,0839 | 3,26 | 7 | 96 | 0 | ✅ |
| `teia_v0.6` † | 220 | 16 | 0,0839 | 5,98 | 7 | 97 | 2.3 | ✅ |
| `teia_v0.6.1_raw` † | 220 | 16 | 0,0839 | 9,04 | 7 | 89 | 5.7 | ✅ |
| `lzma` | 261 | 0 | 0,0996 | 0,10 | 48 | 69 | n/a | ✅ |
| `deflate` | 540 | 0 | 0,2060 | 0,21 | 0 | 42 | n/a | ✅ |
| `gzip` | 558 | 0 | 0,2129 | 0,21 | 0 | 45 | n/a | ✅ |
...
| Compressor | Repr(B) | Dict(B) | Ratio% | Net Ratio% | Enc(ms) | Dec(ms) | RAM(MB) | SHA-256 |
|-----------|--------|--------|--------|-----------|--------|--------|--------|--------|
| `brotli` | 48 | 0 | 0,0183 | 0,02 | 1 | 43 | n/a | ✅ |
| `lzma` | 270 | 0 | 0,1030 | 0,10 | 38 | 73 | n/a | ✅ |
| `deflate` | 291 | 0 | 0,1110 | 0,11 | 0 | 36 | n/a | ✅ |
| `gzip` | 309 | 0 | 0,1179 | 0,12 | 0 | 28 | n/a | ✅ |
| `teia_v0.5` † | 328 | 0 | 0,1251 | 3,31 | 6 | 194 | 8.9 | ✅ |
| `teia_v0.6` † | 328 | 0 | 0,1251 | 6,02 | 6 | 103 | 5.8 | ✅ |
| `teia_v0.6.1_raw` † | 328 | 0 | 0,1251 | 9,08 | 6 | 84 | 3.9 | ✅ |
...
| Compressor | Repr(B) | Dict(B) | Ratio% | Net Ratio% | Enc(ms) | Dec(ms) | RAM(MB) | SHA-256 |
|-----------|--------|--------|--------|-----------|--------|--------|--------|--------|
| `teia_v0.5` † | 514 | 64 | 0,8654 | 14,90 | 152 | 69 | 10 | ✅ |
| `teia_v0.6` † | 514 | 64 | 0,8654 | 26,90 | 152 | 42 | 0.1 | ✅ |
| `teia_v0.6.1_raw` † | 514 | 64 | 0,8654 | 40,39 | 152 | 17 | 0 | ✅ |
| `lzma` | 976 | 0 | 1,6432 | 1,64 | 38 | 41 | n/a | ✅ |
| `brotli` | 1512 | 0 | 2,5457 | 2,55 | 0 | 4 | n/a | ✅ |
| `deflate` | 3179 | 0 | 5,3523 | 5,35 | 0 | 4 | n/a | ✅ |
| `gzip` | 3197 | 0 | 5,3826 | 5,38 | 1 | 6 | n/a | ✅ |
...
| Compressor | Repr(B) | Dict(B) | Ratio% | Net Ratio% | Enc(ms) | Dec(ms) | RAM(MB) | SHA-256 |
|-----------|--------|--------|--------|-----------|--------|--------|--------|--------|
| `brotli` | 131077 | 0 | 100,0038 | 100,00 | 27 | 29 | n/a | ✅ |
| `deflate` | 131114 | 0 | 100,0320 | 100,03 | 36 | 40 | n/a | ✅ |
| `gzip` | 131132 | 0 | 100,0458 | 100,05 | 20 | 43 | n/a | ✅ |
| `lzma` | 131212 | 0 | 100,1068 | 100,11 | 58 | 83 | n/a | ✅ |
| `teia_v0.5` † | 175140 | 0 | 133,6212 | 139,98 | 92 | 87 | 3.1 | ✅ |
| `teia_v0.6` † | 175140 | 0 | 133,6212 | 145,42 | 92 | 82 | 0 | ✅ |
| `teia_v0.6.1_raw` † | 175140 | 0 | 133,6212 | 151,53 | 92 | 80 | 3 | ✅ |
...
## Comparativo de Latência — v0.5.0 (PS puro) vs v0.6.0 (C# inline) vs v0.6.1_raw (zero I/O)

| Domínio | v0.5 dec_ms | v0.6 dec_ms | v0.6 ganho% | v0.6.1_raw ms | v0.6.1 ganho% | SHA ✅ |
|---------|------------|------------|------------|--------------|--------------|-------|
| `D1_UNIFORM` | 244 | 201 | 17.6% | **203** | **16.8%** | v0.6 ✅ v0.6.1 ✅ |
| `D2_PATTERN` | 96 | 97 | -1% | **89** | **7.3%** | v0.6 ✅ v0.6.1 ✅ |
| `D3_RLE` | 194 | 103 | 46.9% | **84** | **56.7%** | v0.6 ✅ v0.6.1 ✅ |
| `D4_JSON` | 69 | 42 | 39.1% | **17** | **75.4%** | v0.6 ✅ v0.6.1 ✅ |
| `D5_ENTROPY` | 87 | 82 | 5.7% | **80** | **8%** | v0.6 ✅ v0.6.1 ✅ |
...
| Startup pwsh por decode | Subprocess por operação | ~269ms fixo | ✅ RESOLVIDO v3 — módulo in-process |
...
| WriteAllBytes (~50-100ms HDD) | I/O disco obrigatório por decode | Dominante em buffers grandes | ✅ ELIMINADO v0.6.1 — Invoke-TEIARestoreRaw retorna byte[] |
| ConvertFrom-Json (~30-50ms) | Parser PS lento por decode | Dominante em seeds complexas | ✅ ELIMINADO v0.6.1 — System.Text.Json.JsonDocument.Parse() em C# |
...
*Benchmark_Harness.ps1 v3.2.0 — v0.5: `DEF540A76E1F188DCCA4F6D55D3C06D7B84C0395CF7F82C4A403AE209110F6BE` | v0.6: `1290462833CADD90ADD5FEC38DE9D1BDBB1D9F23235A47DADE3828CB6247C1C1` | v0.6.1: `732300D7D7A4BCEC530C601261F32CA44A5C7F3667305FF247AE9EE2D61AAC14`*

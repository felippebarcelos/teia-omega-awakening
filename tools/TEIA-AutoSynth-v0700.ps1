<#
.SYNOPSIS
    TEIA-AutoSynth-v0700.ps1 — Forja Ontoprocedural de Micro-Motores Procedurais P10.0
...
.DESCRIPTION
    ...
    Fases de Execução:
      ...
      FASE 5 — Cristalização: P1 Patch aprovado em D:\TEIA_CORE\decoders\
...
function Write-SYNTH([string]$t) { Write-Host "  [SYNTH] $t" -ForegroundColor Yellow }

Write-Host ''
Write-Host ('=' * 72) -ForegroundColor Cyan
Write-Host '  TEIA-AutoSynth v0.70.0 — Forja Ontoprocedural' -ForegroundColor Cyan
Write-Host ('=' * 72) -ForegroundColor Cyan
...
# ─────────────────────────────────────────────────────────────────────────────
# FASE 5 — Cristalização (P1 Patch Aprovado)
# ─────────────────────────────────────────────────────────────────────────────

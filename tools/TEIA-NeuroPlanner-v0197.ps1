<#
.SYNOPSIS
    TEIA-NeuroPlanner-v0197.ps1 — Motor Seletor Determinístico (Rule-First + HR5)

.DESCRIPTION
    Arquitetura v0.19.7 — árvore de decisão "Regra Primeiro, IA Depois":
...
$banner = @"
======================================================================
 [TCT/NEUROPLANNER_v0197] TEIA-NeuroPlanner-v0197.ps1
...
Write-Host ' RELATÓRIO FINAL — TEIA-NeuroPlanner-v0197' -ForegroundColor Cyan
Write-Host $('=' * 70)

#!/usr/bin/env python3
"""
_notary.py — RFC 3161 Timestamp Authority client for TEIA audit chains.
...
Usage (CLI):
  ...
  teia-notarize --hash <hex64> --out notarized/
  teia-notarize --chain audit.jsonl --tsa https://freetsa.org/tsr

Usage (Python API):
  from teia_cognitive_router._notary import notarize, read_last_anchor, build_tsq

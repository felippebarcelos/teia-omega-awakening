# Relatorio Comparativo v8.0.0 — TEIA Selector Engine (105 arquivos)

> **Gerado**: 2026-05-25T19:37:25Z
> **Motor**: TEIA-Core-v0.9.0.psm1 | SHA-256: 35e4937c5edbf39c46514c04fe1680b216c287730eb319f444b3984eed99ef3c | 25134 bytes
> **Hardware**: i3-10100F, 16GB RAM, HDD
> **Corpus**: D7_REAL_MANIFEST.json | 105 arquivos | zero overlap D4 | seed=42 (mesmo que v7)
> **Classificacao**: Benchmark Robusto

---

## Selector Engine v0.9 — Estrategia de Probe por Bucket

| Bucket | Opcodes Probados | Selecao |
|--------|-----------------|---------|
| tiny (<5KB) | zstd.raw + xz.raw | min(D) |
| small (5-100KB) | dict.zstd_shared(dict-small) + zstd.raw | min(D) |
| medium (100-500KB) | dict.zstd_shared(dict-medium) + zstd.raw | min(D) |
| large (>=500KB) | zstd.raw + xz.raw | min(D) |

**Racional xz.raw**: payload XZ/LZMA2 tem overhead ~80B (vs ~200-350B do .7z archive).
Container .teia adiciona ~165B → D_xz = XZ_stream + ~245B.
Coluna A usa .7z format = LZMA_stream + ~200-350B → D_xz < A quando 7z_overhead > 245B.
...
|----|----|------|------|-------|-----|------|-----|------|-----|-------|-----|-----|--------|------|-----|
| R1 | paginators-1.json | tiny | 3064 | 460 | 15.01% | 312 | 10.18% | 312 | 10.18% | 478 | 15.6% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R2 | paginators-1.json | tiny | 2913 | 485 | 16.65% | 346 | 11.88% | 346 | 11.88% | 512 | 17.58% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R3 | paginators-1.json | tiny | 1313 | 377 | 28.71% | 231 | 17.59% | 231 | 17.59% | 397 | 30.24% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R4 | paginators-1.json | tiny | 1778 | 394 | 22.16% | 250 | 14.06% | 250 | 14.06% | 416 | 23.4% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R5 | paginators-1.json | tiny | 1591 | 391 | 24.58% | 247 | 15.52% | 247 | 15.52% | 413 | 25.96% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R6 | paginators-1.json | tiny | 1149 | 355 | 30.9% | 215 | 18.71% | 215 | 18.71% | 381 | 33.16% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R7 | paginators-1.json | tiny | 3466 | 485 | 13.99% | 343 | 9.9% | 343 | 9.9% | 509 | 14.69% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R8 | paginators-1.json | tiny | 1373 | 376 | 27.39% | 234 | 17.04% | 234 | 17.04% | 400 | 29.13% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R9 | paginators-1.json | tiny | 1126 | 389 | 34.55% | 242 | 21.49% | 242 | 21.49% | 408 | 36.23% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R10 | paginators-1.json | tiny | 1549 | 386 | 24.92% | 242 | 15.62% | 242 | 15.62% | 408 | 26.34% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R11 | paginators-1.json | tiny | 1603 | 382 | 23.83% | 240 | 14.97% | 240 | 14.97% | 406 | 25.33% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R12 | paginators-1.json | tiny | 3043 | 613 | 20.14% | 467 | 15.35% | 467 | 15.35% | 633 | 20.8% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R13 | paginators-1.json | tiny | 1007 | 334 | 33.17% | 194 | 19.27% | 194 | 19.27% | 360 | 35.75% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R14 | paginators-1.json | tiny | 1126 | 389 | 34.55% | 242 | 21.49% | 242 | 21.49% | 408 | 36.23% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R15 | paginators-1.json | tiny | 1699 | 418 | 24.6% | 276 | 16.24% | 276 | 16.24% | 442 | 26.02% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R16 | paginators-1.json | tiny | 1259 | 385 | 30.58% | 234 | 18.59% | 234 | 18.59% | 400 | 31.77% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R17 | paginators-1.json | tiny | 1076 | 368 | 34.2% | 218 | 20.26% | 218 | 20.26% | 384 | 35.69% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R18 | paginators-1.json | tiny | 1472 | 474 | 32.2% | 322 | 21.88% | 322 | 21.88% | 488 | 33.15% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R19 | paginators-1.json | tiny | 1221 | 361 | 29.57% | 218 | 17.85% | 218 | 17.85% | 384 | 31.45% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
| R20 | paginators-1.json | tiny | 2870 | 542 | 18.89% | 395 | 13.76% | 395 | 13.76% | 561 | 19.55% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
...
| R29 | waiters-2.json | small | 5118 | 619 | 12.09% | 468 | 9.14% | 391 | 7.64% | 631 | 12.33% | NAO | Z.raw | OVERHEAD_CANCELA | OK |
...
| R96 | service-2.json | large | 926847 | 82931 | 8.95% | 83409 | 9% | 83409 | 9% | 83004 | 8.96% | NAO | X.raw | LZMA_JANELA | OK |
...
| R100 | service-2.json | large | 673116 | 65466 | 9.73% | 65597 | 9.75% | 65597 | 9.75% | 65536 | 9.74% | NAO | X.raw | LZMA_JANELA | OK |
...
| Bucket | N | Wins | A% | B% | D% | Ovhd | LJ | DP | OC | Z.raw | Dict | X.raw | SHA |
|--------|---|------|----|----|----|------|----|----|-----|-------|------|-------|-----|
| tiny | 20 | 0/20 | 26.03% | 16.58% | 27.4% | ~166B | 0 | 0 | 20 | 20 | 0 | 0 | 100%OK |
| small | 45 | 44/45 | 16.33% | 15.87% | 14.17% | ~273B | 0 | 0 | 1 | 1 | 44 | 0 | 100%OK |
| medium | 25 | 25/25 | 10.25% | 10.1% | 9.44% | ~272B | 0 | 0 | 0 | 0 | 25 | 0 | 100%OK |
| large | 15 | 13/15 | 8.59% | 8.43% | 8.45% | ~164B | 2 | 0 | 0 | 13 | 0 | 2 | 100%OK |
| **TOTAL** | **105** | **82/105** | — | — | — | — | — | — | — | — | — | — | **100% OK** |

---

## Diagnóstico de Perdas (v8 vs v7)

| Categoria | v7 (82/105) | v8 |
|-----------|------------|-----|
| GANHA | 82 | 82 |
| LZMA_JANELA | 2 | 2 |
| DICT_PREJUDICA | 0 | 0 |
| OVERHEAD_CANCELA | 21 | 21 |

### Perdas restantes:
- **R1** (paginators-1.json, tiny, 3064B): D-A=+18B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R2** (paginators-1.json, tiny, 2913B): D-A=+27B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R3** (paginators-1.json, tiny, 1313B): D-A=+20B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R4** (paginators-1.json, tiny, 1778B): D-A=+22B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R5** (paginators-1.json, tiny, 1591B): D-A=+22B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R6** (paginators-1.json, tiny, 1149B): D-A=+26B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R7** (paginators-1.json, tiny, 3466B): D-A=+24B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R8** (paginators-1.json, tiny, 1373B): D-A=+24B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R9** (paginators-1.json, tiny, 1126B): D-A=+19B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R10** (paginators-1.json, tiny, 1549B): D-A=+22B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R11** (paginators-1.json, tiny, 1603B): D-A=+24B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R12** (paginators-1.json, tiny, 3043B): D-A=+20B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R13** (paginators-1.json, tiny, 1007B): D-A=+26B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R14** (paginators-1.json, tiny, 1126B): D-A=+19B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R15** (paginators-1.json, tiny, 1699B): D-A=+24B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R16** (paginators-1.json, tiny, 1259B): D-A=+15B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R17** (paginators-1.json, tiny, 1076B): D-A=+16B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R18** (paginators-1.json, tiny, 1472B): D-A=+14B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R19** (paginators-1.json, tiny, 1221B): D-A=+23B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R20** (paginators-1.json, tiny, 2870B): D-A=+19B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R29** (waiters-2.json, small, 5118B): D-A=+12B | Razão: OVERHEAD_CANCELA | Opcode selecionado: zstd.raw
- **R96** (service-2.json, large, 926847B): D-A=+73B | Razão: LZMA_JANELA | Opcode selecionado: xz.raw
- **R100** (service-2.json, large, 673116B): D-A=+70B | Razão: LZMA_JANELA | Opcode selecionado: xz.raw

---

## Distribuição de Opcodes (Selector Engine)

| Opcode | Total selecionado | % arquivos |
|--------|------------------|-----------|
| zstd.raw | 34 | 32.4% |
| dict.zstd_shared | 69 | 65.7% |
| xz.raw | 2 | 1.9% |
...
**82 arquivos ganhos** | Economia total: **103997B** vs LZMA standalone
...
*v7→v8 delta: TEIA 82/105 (antes 82/105). Economia: 103997B (antes 102,592B).*

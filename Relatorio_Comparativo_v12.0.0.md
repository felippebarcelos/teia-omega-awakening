# Relatorio Comparativo v12.0.0 — Regressao D7 com Motor v0.11.0 (105 arquivos)

> **Gerado**: 2026-05-25T20:26:13Z
> **Motor**: TEIA-Core-v0.11.0.psm1 | SHA-256: a56b18c0e17f4d1037340adf78f057f44e0fdbe21a5201fca6e1d17fb379ec39 | 35864 bytes
> **Corpus**: D7_REAL_MANIFEST.json | 105 arquivos | zero overlap D4 | seed=42 (mesmo que v7/v8/v9)
...
> **Objetivo**: Confirmar 105/105 sem regressao apos adicao do probe cmp.lzma em small/medium/large

---

## Motor v0.11.0 — Probe Sets

| Bucket | Opcodes Probados | Selecao |
|--------|-----------------|---------|
| tiny (<5KB) | cmp.zstd | cmp.zstd (overhead 72B) |
| small (5-100KB) | cmp.zstd + cmp.lzma + dict.zstd_shared(dict-small) | min(D) |
| medium (100-500KB) | cmp.lzma + dict.zstd_shared(dict-medium) + cmp.zstd | min(D) |
| large (>=500KB) | cmp.lzma + cmp.xz + zstd.raw | min(D) |

**Expectativa**: dict domina small/medium (botocore/Google API JSON — domain-matched). cmp.lzma adicionado como probe nao deve vencer em corpus D7 (Zstd-dominant files). Regressao = 0.

---

## Resultado de Regressao

**ZERO REGRESSOES — 105/105 TEIA ganha. Motor v0.11.0 compativel com D7.**

| Metrica | v9 (v0.10) | v12 (v0.11) | Delta |
|---------|-----------|------------|-------|
| Wins | 105/105 | 105/105 | 0 (OK) |
| Net savings vs LZMA | 105574B | 121812B | 16238B |
| SHA-256 | 100% OK | 100% OK | — |
| cmp.lzma selecionado | 0 | 15 | +15 |
...
| R91 | service-2.json | large | 556492 | 46164 | 8.3% | 45498 | 8.18% | 45498 | 8.18% | 45070 | 8.1% | SIM | C.lzma | GANHA | OK |
| R92 | service-2.json | large | 847080 | 76733 | 9.06% | 75084 | 8.86% | 75084 | 8.86% | 74216 | 8.76% | SIM | C.lzma | GANHA | OK |
| R93 | service-2.json | large | 891280 | 80806 | 9.07% | 78951 | 8.86% | 78951 | 8.86% | 78127 | 8.77% | SIM | C.lzma | GANHA | OK |
| R94 | service-2.json | large | 812261 | 81214 | 10% | 79911 | 9.84% | 79911 | 9.84% | 78890 | 9.71% | SIM | C.lzma | GANHA | OK |
| R95 | service-2.json | large | 588390 | 57551 | 9.78% | 56489 | 9.6% | 56489 | 9.6% | 55866 | 9.49% | SIM | C.lzma | GANHA | OK |
| R96 | service-2.json | large | 926847 | 82931 | 8.95% | 83409 | 9% | 83409 | 9% | 81775 | 8.82% | SIM | C.lzma | GANHA | OK |
| R97 | service-2.json | large | 588264 | 48165 | 8.19% | 46630 | 7.93% | 46630 | 7.93% | 46035 | 7.83% | SIM | C.lzma | GANHA | OK |
| R98 | service-2.json | large | 3018739 | 230206 | 7.63% | 222692 | 7.38% | 222692 | 7.38% | 218383 | 7.23% | SIM | C.lzma | GANHA | OK |
| R99 | service-2.json | large | 540601 | 50296 | 9.3% | 48945 | 9.05% | 48945 | 9.05% | 48546 | 8.98% | SIM | C.lzma | GANHA | OK |
| R100 | service-2.json | large | 673116 | 65466 | 9.73% | 65597 | 9.75% | 65597 | 9.75% | 64281 | 9.55% | SIM | C.lzma | GANHA | OK |
| R101 | service-2.json | large | 562255 | 38496 | 6.85% | 37159 | 6.61% | 37159 | 6.61% | 36709 | 6.53% | SIM | C.lzma | GANHA | OK |
| R102 | service-2.json | large | 763800 | 42353 | 5.55% | 41330 | 5.41% | 41330 | 5.41% | 40658 | 5.32% | SIM | C.lzma | GANHA | OK |
| R103 | service-2.json | large | 661619 | 59931 | 9.06% | 59040 | 8.92% | 59040 | 8.92% | 58350 | 8.82% | SIM | C.lzma | GANHA | OK |
| R104 | service-2.json | large | 539923 | 53264 | 9.87% | 52276 | 9.68% | 52276 | 9.68% | 51779 | 9.59% | SIM | C.lzma | GANHA | OK |
| R105 | service-2.json | large | 629302 | 47555 | 7.56% | 46439 | 7.38% | 46439 | 7.38% | 46025 | 7.31% | SIM | C.lzma | GANHA | OK |

---

## Sumario por Bucket

| Bucket | N | Wins | A% | B% | D% | Ovhd | LJ | DP | OC | C.zst | C.lzma | C.xz | Dict | Z.raw | X.raw | SHA |
|--------|---|------|----|----|----|------|----|----|-----|-------|--------|------|------|-------|-------|-----|
| tiny | 20 | 20/20 | 26.03% | 16.58% | 21.28% | ~72B | 0 | 0 | 0 | 20 | 0 | 0 | 0 | 0 | 0 | 100%OK |
| small | 45 | 45/45 | 16.33% | 15.87% | 14.13% | ~271B | 0 | 0 | 0 | 1 | 0 | 0 | 44 | 0 | 0 | 100%OK |
| medium | 25 | 25/25 | 10.25% | 10.1% | 9.44% | ~272B | 0 | 0 | 0 | 0 | 0 | 0 | 25 | 0 | 0 | 100%OK |
| large | 15 | 15/15 | 8.59% | 8.43% | 8.32% | ~69B | 0 | 0 | 0 | 0 | 15 | 0 | 0 | 0 | 0 | 100%OK |
